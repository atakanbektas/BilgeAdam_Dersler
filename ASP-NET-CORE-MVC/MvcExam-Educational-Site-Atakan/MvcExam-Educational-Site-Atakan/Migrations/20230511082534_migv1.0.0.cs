    ...
    public partial class migv100 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    EducationInfo = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    WorkingInfo = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesCertificates", x => new { x.CourseId, x.CertificateId });
                    table.ForeignKey(
                        name: "FK_CoursesCertificates_Certificates",
                        column: x => x.CertificateId,
                        principalTable: "Certificates",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CoursesCertificates_Courses",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentsCourses_Courses",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StudentsCourses_Students",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursesCertificates_CertificateId",
